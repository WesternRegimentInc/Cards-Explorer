                                    ...
                                    @foreach($cards as $card)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.card.delete', ['id'=> $card->id]) }}" data-url="{{ route('admin.card.delete', ['id'=> $card->id]) }}" class="btn btn-danger btn-xs delBtn" data-id="{{$card->id}}"><i class="fa fa-trash-o"></i> Delete </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
